...
public class jdUbahPassword extends javax.swing.JDialog {
    ...
    private void updatePassword(){
        ...
        try{
            ...
            sqlselect = "select * from tbuser where id_user='"+vid_user+"' and password='"+vpasslama+"' ";
            Statement stat = _Cnn.createStatement();
            ResultSet res = stat.executeQuery(sqlselect);
            if(res.first()){
                sqlinsert = "update tbuser set password='"+vpassbaru+"' where id_user='"+vid_user+"' ";
                ...
                JOptionPane.showMessageDialog(null, "Password lama tidak sesuai", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                txtPassLama.setText("");
                txtPassLama.requestFocus(true);
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Input :"));
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Password Baru :"));

        txtPassBaru.setBackground(new java.awt.Color(204, 255, 204));
        jScrollPane2.setViewportView(txtPassBaru);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(btnReset, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35))))
        );

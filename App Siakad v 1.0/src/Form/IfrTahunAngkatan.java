   ...
   String vid_ta, vtahun_angkatan;
    ...
    private void showTabel(){
        try{
            ...
            JOptionPane.showMessageDialog(this, "Eror method showDataTabel() : "+ex);
        }
    }
    ...
    private void createAutoID(){
        try{
            ...
            JOptionPane.showMessageDialog(this, "Eror method createAutoID() : " + ex,"Informasi", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    /**
